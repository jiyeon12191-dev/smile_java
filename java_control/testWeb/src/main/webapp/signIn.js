// 로그인 버튼 클릭할때 아이디 입력 안되어있으면?
// 로그인 버튼 클릭시 아이디는 입력했거 비밀번호 입력 안되어 있으면?
// 로그인 페이지 열렸을때(로드) 처음에 무엇을 할꺼냐?


window.onload = function(){
    // 아이디 입력하는 input태그에 커서를 두겟다.
    let id = this.document.getElementById("userId");
    id.focus(); //커서 표시
