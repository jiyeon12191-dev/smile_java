...
public class Board {
	...
	/*
	    ...
	    public void 메서드 이용 () {}
	     ...
	     2. 매개변수만 있는 메서드
	     public void 메서드 이용 (메개변수1,메개변수2) {}
	     
	     3. 반환(return)만있는 메서드
	     public String 메서드 이용 () { return String변수; }
	     
	     4. 메게변수 있고 , 반환(return)도 있는 메서드
	     public int 메서드이용 (메개변수1,메개변수2) {return int변수 }
